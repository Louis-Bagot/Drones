...
/*    Drone d = new Drone();
    VecteurR3 posObj = new VecteurR3(0,0,0);
...
//void testsDrone::testUpdateCapteurs(void) {
  ...
  std::vector<VecteurR3> vVR3;
  vVR3.push_back(new VecteurR3(0.6,0.5,0.5));
  vObstacles.push_back(new Obstacle(vVR3));
  std::vector<VecteurR3> vDirCapt;
  vCapt.push_back(new VecteurR3(1,0,0));
  Drone d = new Drone(0,  NULL,  ,new VecteurR3(0.5,0.5,0.5));
