...
void testsEnvironnement::testcalculerPos(void)
{
 /**On va d'abord crée un environnement vide. Dans lequel on va créée un essaim
 * composé de 1 drone seul. On va donner pour ordre au drone d'aller à une position
